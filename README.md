...
* Windows 11 & Windows 10:تم استخدامها كأجهزة مستخدمين لتوليد سجلات الأحدث
(Event Logs)
* Kali Linux:تم استخدامه كمنصة هجوم لتنفيذ سيناريوهات الاختراق ومحاكاة الاتصالات المشبوهة.
